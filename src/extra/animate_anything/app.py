...
class AnimateController:
    ...
    def __init__(self, pretrained_model_path: str, validation_data,
        ...
        #       we cast the text_encoder and vae weights to half-precision
    ...
    def animate(
        ...
        print(f"\noutfile {save_sample_path}, prompt {prompt_textbox}, motion_strength {motion_strength}")
        with torch.no_grad():
        ...
        with gr.Row(equal_height=False):
            with gr.Column():
                with gr.Row():
                    ...
                    init_img = gr.ImageEditor(label='Input Image')
...
if __name__ == "__main__":
    ...
    args_base = OmegaConf.load(args.config)
    args_dict = OmegaConf.merge(args_base, args_cli)
    ...
    demo.launch(server_name=args.server,
