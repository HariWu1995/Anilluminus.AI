...
class AnimateController:
    ...
    def __init__(self, base_dir: str = None):
        ...
        # config dirs
        self.basedir = base_dir if base_dir is not None else os.getcwd()
        self.stable_diffusion_dir   = os.path.join(self.basedir, "models", "StableDiffusion")
        self.motion_module_dir      = os.path.join(self.basedir, "models", "Motion_Module")
        self.personalized_model_dir = os.path.join(self.basedir, "models", "DreamBooth_LoRA")
        self.savedir                = os.path.join(self.basedir, "samples", datetime.now().strftime("AnimateDiff-%Y-%m-%dT%H-%M-%S"))
