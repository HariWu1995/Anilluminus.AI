...
class BiRefNetPortrait(BiRefNetGeneral):
    """
    This class represents a BiRefNet-Portrait session, which is a subclass of BiRefNetGeneral.
    """
    ...
    def download_models(cls, *args, **kwargs):
        ...
        pooch.retrieve(
            ...
            None if cls.checksum_disabled(*args, **kwargs) else "md5:c3a64a6abf20250d090cd055f12a3b67",
            fname=fname,
