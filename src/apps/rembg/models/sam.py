...
class Sam(BaseModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        """
        Initialize a new Sam with the given model name and session options.
        ...
        self.encoder = ort.InferenceSession(str(paths[0]), providers=valid_providers, sess_options=sess_opts)
        self.decoder = ort.InferenceSession(str(paths[1]), providers=valid_providers, sess_options=sess_opts)
    ...
    def predict(
        ...
        **kwargs,
        ...
        Returns:
            List[ImageClass]: A list of masks generated by the decoder.
        """
        ...
        onnx_coord = np.concatenate([onnx_coord, 
                                     np.ones((1, onnx_coord.shape[1], 1), dtype=np.float32),], axis=2,)
